...
const Auth = (props) => {
  ...
  const handleLogin = () => {
    ...
    loginApi(user, (isOk, data) => {
      ...
      // localStorage.setItem("username", "akbar");
      localStorage.setItem("userId", data.userId);
      // localStorage.setItem("userId", 2);
      localStorage.setItem("token", data["token"]);
      // localStorage.setItem("token", "asdASD@#!#$#@%$AFAasdad");
      window.location.reload();
    });
  };
        ...
        {tab === LOGIN_TAB_VALUE && (
          <>
            <div className={classes.container}>
              ...
              <section className={classes.loginInfoSection}>
                <Input
        ...
        {tab === FORGOT_PASSWORD && (
          <>
            <section className={classes.container}>
              ...
              <section className={classes.forgetPassSection}>
                <Input
                  className={classes.input}
                  type="tel"
                  placeholder={"موبایل"}
        ...
        {tab === REG_TAB_VALUE && (
          <>
            <section className={classes.container}>
              ...
              <section className={classes.registerInfoSection}>
                <Input
                  className={classes.input}
                  type="text"
                  placeholder={"نام"}
